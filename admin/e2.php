...
?>
 ...
 <?php include"conn.php";
        ...
        $sql="SELECT * FROM rooms WHERE room_category='BLOCK E' AND status ='0'";
        if ($result=$conn->query($sql)) {
          # code...
...
if (isset($_GET['update'])) {
  ...
  echo "<script>window.open('e2.php', '_SELF')</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="e.php">Home</a>
  ...
  ?>
                  ...
                  <td><a href="e2.php?update=<?php echo $row['id'];?>" class="btn btn-primary">Reserve</a></td> 
