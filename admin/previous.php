            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><a href="show.php?pin=<?php echo base64_encode($value['invoiceno'])?>&uim=<?php echo base64_encode($value['appno']);?>" target="_blank" class="btn btn-info" style="color: white;text-decoration: none;" data-toggle="tooltip" data-placement="top" title="view details"><i class="fa fa-edit"></i></a>
                    ...
                    <a href="process.php?edit=<?php echo base64_encode($value['invoiceno']);?>" class="btn btn-success" style="color: white;text-decoration: none;" data-toggle="tooltip" data-placement="top" title="process request"><i class="fa fa-check"></i></a> 
                    
                    <a href="comment.php?edit=<?php echo base64_encode($value['invoiceno']);?>" class="btn btn-warning" style="color:white;text-decoration: none;" data-toggle="tooltip" data-placement="top" title="comment"><i class="fa fa-comment"></i> </a>
                    </td>
                </tr>
                <?php }?>
                </tbody>
