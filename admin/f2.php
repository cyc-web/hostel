...
?>
 ...
 <?php include"conn.php";
        ...
        $sql="SELECT * FROM rooms WHERE room_category='BLOCK F' AND status ='0'";
        if ($result=$conn->query($sql)) {
          # code...
...
if (isset($_GET['update'])) {
  ...
  echo "<script>window.open('f2.php', '_SELF')</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="f.php">Home</a>
  ...
  ?>
                  ...
                  <td><a href="f2.php?update=<?php echo $row['id'];?>" class="btn btn-primary">Reserve</a></td> 
