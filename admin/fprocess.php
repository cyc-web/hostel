...
if (in_array(1, $user) || in_array(9, $user) || in_array(13, $user)) {
...
error_reporting(0);
 ...
 if (isset($_POST['submit'])) {
    ...
    $appno=$_POST['appno'];
     ...
     $sql3="INSERT INTO trans_docs(invoiceno,appno, sessionadmin,sessiongrad,comments,name,section,update_time,status)VALUES('$invoiceno','$appno', '$sessionadmin', '$sessiongrad', 'Your transcript request has been treated and forwarded to result office for further process', '$officer', '$tasks', now(), 'treated')";
     
     $conn->query($sql3);
     $last_id = mysqli_insert_id($conn);
     if ($last_id) {
         $sql2="UPDATE trans_docs SET status='ok' WHERE invoiceno='$invoiceno' AND status='comment'";
         $sql="UPDATE transinvoice SET invoice_flag ='2' WHERE invoiceno='$invoiceno' AND invoice_flag='1'";
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php if (!empty($start) && !empty($end)) {
                    ...
                    <?php }else{?>
                        <a href="file.php" class="btn btn-primary"><i class="fas fa-arrow-circle-left"></i> back</a>
                    <?php }?>
                </div><!-- /.col -->
                <div class="col-sm-6">
