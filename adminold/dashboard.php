...
include('conn.php');
        ...
        $sql=mysqli_query($conn, "SELECT room, room_category FROM room WHERE room_category = 'BLOCK A' AND status='0'")or die(mysqli_error($conn));
...
include('conn.php');
        ...
        $sql=mysqli_query($conn, "SELECT room, room_category FROM room WHERE room_category = 'BLOCK B' AND status='0'")or die(mysqli_error($conn));
...
include('conn.php');
        ...
        $sql=mysqli_query($conn, "SELECT room, room_category FROM room WHERE room_category = 'BLOCK C' AND status='0'")or die(mysqli_error($conn));
...
include('conn.php');
        ...
        $sql=mysqli_query($conn, "SELECT room, room_category FROM room WHERE room_category = 'BLOCK D' AND status='0'")or die(mysqli_error($conn));
...
include('conn.php');
        ...
        $sql=mysqli_query($conn, "SELECT room, room_category FROM room WHERE room_category = 'BLOCK E' AND status='0'")or die(mysqli_error($conn));
...
include('conn.php');
        ...
        $sql=mysqli_query($conn, "SELECT room, room_category FROM room WHERE room_category = 'BLOCK F' AND status='0'")or die(mysqli_error($conn));
...
include('conn.php');
        ...
        $sql=mysqli_query($conn, "SELECT room, room_category FROM room WHERE room_category = 'BLOCK G' AND status='0'")or die(mysqli_error($conn));
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="dashboard.php">Admin section <?php echo $row['name']?></a>
